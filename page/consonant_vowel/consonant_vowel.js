const vowel = ["ង្ក","ង្គ","ង្ខ","ង្ឃ","ង្រ","ង្វ","ង្ស","ង្ហ","ង្អ","ង្គ្រ"]
...
for ( i in vowel){
    ...
    s.style.backgroundImage = 'url(https://github.com/viaasana/tu_luyen_chu_viet_tieng_khmer_nam_bo/blob/main/image/chong_van/'+ i + '.png?raw=true)'
...
function open_video_button(video_id){
    ...
    video.src ='https://github.com/viaasana/tu_luyen_chu_viet_tieng_khmer_nam_bo/blob/main/video/chong_van/'+ video_id + '.mp4?raw=true';
    video.id = 'video'
    video.autoplay = true
...
function open_sound_button(sound_id){
    ...
    audio.src ='https://github.com/viaasana/tu_luyen_chu_viet_tieng_khmer_nam_bo/blob/main/sound/PHU_AM_CHONG_VAN/Recording%20(' + parseFloat(sound_id  + 93)+ ').m4a?raw=true'
    audio.id = 'audio'
    audio.autoplay = true
